document.addEventListener("DOMContentLoaded", function () {
  ...
  function showQuestion() {
    ...
    questions[currentQuestionIndex].choices.forEach((choices) => {
      ...
      }); //So the correct understanding is.The arrow function is stored firstAfter click, the arrow function executesInside it, selectAnswer(choice) executes.It is mainly being used as a wrapper function to delay execution and pass choice.
